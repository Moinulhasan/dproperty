    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="col-xxl">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.testimonial.edit.post',$testimonial)); ?>" method="POST"
                                ...
                                <div class="col-8">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input type="text" class="form-control" name="name"
                                                   placeholder="Enter slider title" value="<?php echo e($testimonial->name); ?>"/>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input type="text" class="form-control" name="designation"
                                                   ...
                                                   value="<?php echo e($testimonial->designation); ?>"/>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <textarea class="form-control" name="review"
                                                      placeholder="Enter Review"><?php echo e($testimonial->review); ?></textarea>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="">
                                                <img src="<?php echo e($testimonial->image); ?>" alt="" class="mt-2" style="width: 100px; height: 60px;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input class="form-control" name="s_link" type="text"
                                                   ...
                                                   value="<?php echo e($testimonial->s_link); ?>"></input>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="multicol-country" name="status" class="select form-select"
                                                ...
                                                <option value="active" <?php echo e($testimonial->status ==1 ?'selected':''); ?>>
                                                    Active
                                                </option>
                                                <option value="inactive" <?php echo e($testimonial->status ==0 ?'selected':''); ?>>
                                                    InActive
                                                </option>
                                            </select>
                                        </div>
...
<?php echo $__env->make('admin.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/Property/dproperty/resources/views/admin/testimonial/edit.blade.php ENDPATH**/ ?>