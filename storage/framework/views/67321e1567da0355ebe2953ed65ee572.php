    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="col-xxl">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.property.add.post')); ?>" method="POST"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input type="text" class="form-control" name="link"
                                                   placeholder="Enter property link" value="<?php echo e(old('link')); ?>"/>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <textarea class="form-control" name="description"
                                                      placeholder="Enter Review"><?php echo e(old('description')); ?></textarea>
                                        </div>
...
<?php echo $__env->make('admin.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/Property/dproperty/resources/views/admin/property/add.blade.php ENDPATH**/ ?>