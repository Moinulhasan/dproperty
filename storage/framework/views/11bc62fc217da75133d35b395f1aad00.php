    ...
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6">
                <h5 class="fw-bold mb-3">
                    <a href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset('images/logo_main.png')); ?>" alt="logo" class="mb-2" style="height: 40px;">
                    </a>
                </h5>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end">
                <a href="<?php echo e(route('privacy-policy')); ?>" class="text-light text-decoration-none me-3">Privacy Policy</a>
                <a href="<?php echo e(route('terms-of-use')); ?>" class="text-light text-decoration-none me-3">Terms of Service</a>
                <a href="<?php echo e(route('site-map')); ?>" class="text-light text-decoration-none">Sitemap</a>
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH /var/www/html/Property/dproperty/resources/views/component/footer.blade.php ENDPATH**/ ?>