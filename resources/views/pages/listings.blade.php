        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="property-card-global">
                <div class="card-image-box">
                    ...
                    @php
                        // Build the card's image list ONCE. Feature image
                        // first, then gallery images. Dedupe so a feature
                        // image that's also present in the images[] array
                        // isn't rendered twice. The card slider, the popup
                        // gallery, and any other consumer all read the same
                        // list, so the "first image" is consistent
                        // regardless of where it's pulled from.
                    ...
                    <!-- Inner Card Slider — renders the same deduplicated
                         $allImages list built above so the feature image is
                         GUARANTEED to be slide 0, with no double-render. -->
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize all inner card sliders. loop disabled: with loop on,
        // Swiper clones slides and can land on a clone first, so the
        // feature image (slide 0) wasn't always the visible starting slide.
