    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="col-xxl">
                    <div class="card-body">
                        <form action="{{route('admin.slider.edit.post',$slider)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="row">
                                <div class="col-2"></div>
                                <div class="col-8">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="">
                                                <img src="{{$slider->image}}" alt="" class="mt-2" style="width: 100px; height: 60px;">
                                            </div>
                                        </div>
                                        @if($errors->has('file'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="multicol-country" name="status" class="select form-select"
                                                ...
                                                <option value="active" {{$slider->status ==1 ?'selected':''}}>Active</option>
                                                <option value="inactive" {{$slider->status ==0 ?'selected':''}}>InActive</option>
                                            </select>
                                        </div>
                                    </div>
