    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="col-xxl">
                    <div class="card-body">
                        <form action="{{route('admin.testimonial.edit.post',$testimonial)}}" method="POST"
                                ...
                                <div class="col-8">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <textarea class="form-control" name="review"
                                                      placeholder="Enter Review">{{ $testimonial->review }}</textarea>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="">
                                                <img src="{{$testimonial->image}}" alt="" class="mt-2" style="width: 100px; height: 60px;">
                                            </div>
                                        </div>
                                        @if($errors->has('file'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input class="form-control" name="s_link" type="text"
                                                   ...
                                                   value="{{ $testimonial->s_link }}"></input>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="multicol-country" name="status" class="select form-select"
                                                ...
                                                <option value="active" {{$testimonial->status ==1 ?'selected':''}}>
                                                    Active
                                                </option>
                                                <option value="inactive" {{$testimonial->status ==0 ?'selected':''}}>
                                                    InActive
                                                </option>
                                            </select>
                                        </div>
