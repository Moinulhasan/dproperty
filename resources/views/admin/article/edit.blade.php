    ...
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.article.edit.post', $article->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-3">
                        <label class="form-label" for="article-title">Title</label>
                        <input type="text" class="form-control" id="article-title" name="title" placeholder="Enter article title" value="{{ old('title', $article->title) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($article->image)
                            <div class="mb-2">
                                <img src="{{ asset($article->image) }}" alt="Preview" width="150" class="rounded border">
                            </div>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="summernote" name="content">{{ old('content', $article->content) }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="meta-title" name="meta_title" value="{{ old('meta_title', $article->meta_title) }}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="meta-description">Meta Description</label>
                        <textarea class="form-control" id="meta-description" name="meta_description" rows="2">{{ old('meta_description', $article->meta_description) }}</textarea>
                    </div>

                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <label class="form-label" for="article-order">Order</label>
                            <input type="number" min="0" class="form-control" id="article-order" name="order" value="{{ old('order', $article->order) }}">
