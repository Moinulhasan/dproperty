    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="col-xxl">
                    <div class="card-body">
                        <form action="{{route('admin.location.edit.post', $location)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="row">
                                <div class="col-2"></div>
                                <div class="col-8">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="location-name" name="name" placeholder="Enter location name" value="{{ old('name', $location->name) }}" required />
                                        </div>
                                        @if($errors->has('name'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            @if($location->image)
                                                <div class="mb-2">
                                                    <img src="{{ asset($location->image) }}" alt="{{ $location->name }}" style="width: 200px; height: 120px; object-fit: cover; border-radius: 8px;">
                                                </div>
                                            @endif
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="location-status" name="status" class="select form-select" data-allow-clear="true">
                                                ...
                                                <option value="active" {{ $location->status == 1 ? 'selected' : '' }}>Active</option>
                                                <option value="inactive" {{ $location->status == 0 ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" class="form-control" id="location-order" name="order" value="{{ old('order', $location->order) }}" />
