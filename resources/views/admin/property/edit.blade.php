    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-12">
                ...
                <div class="col-xxl">
                    <div class="card-body">
                        <form action="{{route('admin.property.edit.post',$property)}}" method="POST"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="multicol-country" name="type" class="select form-select"
                                                ...
                                                <option value="fb" {{$property->type =='fb' ? 'selected':''}}>Facebook
                                                </option>
                                                <option value="yu" {{$property->type =='yu' ? 'selected':''}}>Youtube
                                                </option>
                                            </select>
                                            @if($errors->has('type'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input type="text" class="form-control" name="link"
                                                   placeholder="Enter property link" value="{{$property->link}}"/>
                                        </div>
                                        @if($errors->has('link'))
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 ">
                                            <textarea class="form-control" name="description"
                                                      placeholder="Enter Review">{{ $property->description }}</textarea>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="multicol-country" name="status" class="select form-select"
                                                    data-allow-clear="true">
                                                <option value="">Select</option>
                                                <option value="active" {{$property->status ==1 ?'selected':''}}>
                                                    Active
                                                </option>
                                                <option value="inactive" {{$property->status ==0 ?'selected':''}}>
                                                    InActive
                                                </option>
                                            </select>
                                        </div>
